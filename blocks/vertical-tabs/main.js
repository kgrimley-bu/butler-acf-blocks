						...
						function () {
							...
							$respTabs.find( ".resp-accordion" ).each(
								function () {
									...
									$tabItemh2.attr( "aria-controls", options.tabidentify + "_tab_content-" + itemCount );
									itemCount++;
								}
							);
							...
							$respTabs.find( ".resp-tab-item" ).each(
								function ($index) {
									...
									$tabItem.attr( "aria-controls", options.tabidentify + "_tab_content-" + count );
									...
									var tabcount = 0;
									$respTabs.find( ".resp-tab-content." + options.tabidentify ).each(
										function () {
											$tabContent = $( this );
											$tabContent.attr( "aria-labelledby", options.tabidentify + "_tab_item-" + tabcount );
											$tabContent.attr( "id", options.tabidentify + "_tab_content-" + tabcount );
											tabcount++;
										}
									);
									count++;
									...
									$currentTab.on(
										...
										function () {
											...
											if ( ! $currentTab.hasClass( "resp-tab-active" ) && $currentTab.hasClass( "resp-accordion" )) {
												...
												$respTabs.find( ".resp-tab-content[id = " + $tabAria + "]." + options.tabidentify ).addClass( "resp-tab-content-active" );
											}
...
jQuery(
	function ($) {
		const thisTabId = jQuery( ".responsive-tabs.vertical" ).attr( "id" );

		if (thisTabId && $.fn.easyResponsiveTabs) {
			$( "#primary .responsive-tabs.vertical" ).easyResponsiveTabs(
				{
					type: "vertical",
					tabidentify: thisTabId // The tab groups identifier.
				}
			);
		}
	}
